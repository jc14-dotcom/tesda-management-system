        ...
        <div class="w-full max-w-md rounded-2xl bg-white shadow-2xl"
            ...
            <form method="POST" :action="resetUrl">
                    ...
                    <div>
                        ...
                        <div class="relative mt-1">
                            ...
                            <button type="button"
                                    ...
                                    tabindex="-1"
                                    class="absolute inset-y-0 right-0 flex items-center px-3 text-grayTheme-medium transition hover:text-grayTheme-dark"
                        ...
                        {{-- Strength meter --}}
                        <div x-show="pwd.length > 0" x-cloak class="mt-3 space-y-2.5">
                            <div class="flex items-center gap-3">
                                <div class="relative h-1.5 flex-1 overflow-hidden rounded-full bg-grayTheme-hover">
                                    <div class="absolute inset-y-0 left-0 rounded-full transition-all duration-300"
                                         :class="strengthColor"
                                         :style="'width:' + strengthWidthPct"></div>
                                </div>
                    ...
                    <div>
                        ...
                        <div class="relative mt-1">
                            <input id="modal_password_confirmation"
                                   ...
                                   x-model="pwdConfirm"
                                   class="form-input w-full pr-10"
                                   :class="{ 'border-danger focus:ring-danger/30': pwdMismatch, 'border-success focus:ring-success/30': pwdMatch }"
                                   autocomplete="new-password"
                        ...
                        {{-- Feedback --}}
                        <div class="mt-1.5 flex items-center gap-1.5 text-xs" x-show="pwdConfirm.length > 0">
                            <svg x-show="pwdMatch" class="h-3.5 w-3.5 shrink-0 text-success" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/></svg>
                            <svg x-show="pwdMismatch" class="h-3.5 w-3.5 shrink-0 text-danger" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12"/></svg>
                            <span :class="pwdMatch ? 'text-success' : 'text-danger'">
                                <span x-show="pwdMatch">Passwords match</span>
                                <span x-show="pwdMismatch">Passwords do not match</span>
                            </span>
                        </div>
                    </div>
                ...
                <div class="flex items-center justify-end gap-3 border-t border-grayTheme-border px-6 py-4">
                    ...
                    <button type="submit"
                            :disabled="!canSubmit"
                            :class="canSubmit ? 'btn-primary' : 'btn-primary opacity-50 cursor-not-allowed'"
                            class="gap-2 text-sm">
                        <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z"/></svg>
                        Reset Password
                    </button>
