...
class EnsureProfileComplete
{
    public function handle(Request $request, Closure $next): Response
    {
        ...
        if (
            ...
            ! $request->routeIs('profile.complete', 'profile.complete.store', 'logout', 'notifications.poll', 'notifications.panel', 'dashboard.live', 'verification.notice', 'verification.otp.verify', 'verification.send') &&
